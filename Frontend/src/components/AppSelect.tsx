    ...
    >
      ...
      <SelectPrimitive.Portal>
        <SelectPrimitive.Content
          position="popper"
          sideOffset={6}
          className="select-motion z-[100] min-w-[var(--radix-select-trigger-width)] max-w-[calc(100vw-1.5rem)] overflow-hidden rounded-xl border border-gray-border bg-white p-1.5 shadow-xl"
        >
          ...
          <SelectPrimitive.Viewport className="max-h-[60svh] sm:max-h-64">
            {clearLabel && (
