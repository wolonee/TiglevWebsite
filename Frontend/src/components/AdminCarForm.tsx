...
export default function AdminCarForm({ car, onSaved, onCancel }: AdminCarFormProps) {
  ...
  return (
    <form onSubmit={(event) => void submit(event, car ? undefined : "active")} className="space-y-6 sm:space-y-8">
      <section className="admin-form-section rounded-2xl border border-gray-border bg-white p-4 sm:p-8">
      ...
      <section className="admin-form-section rounded-2xl border border-gray-border bg-white p-4 sm:p-8" style={{ animationDelay: "60ms" }}>
