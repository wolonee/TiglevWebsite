      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
          <div className="h-full">
            <div className="h-full rounded-2xl border border-gray-border bg-white p-4 sm:p-8 lg:p-10">
              <ContactList />
            </div>

          </div>

          <div className="rounded-2xl border border-gray-border bg-white p-4 sm:p-8 lg:p-10">
            <ContactForm />
          </div>
        </div>
        <SectionHeading eyebrow="Где нас найти" title="Местоположение" className="mb-6 mt-10 sm:mb-10 sm:mt-16" />
