      ...
      <div className="shell max-w-4xl">
        ...
        <div className="rounded-2xl border border-gray-border bg-white px-6">
          ...
          <Section
            ...
            note="Статус заявки. Тёмная — не просмотрена, янтарная — в работе, зелёная — закрыта, без заливки — убрана из работы. Красной здесь нет намеренно: красный занят целевым действием, и метка рядом с кнопкой читалась бы как вторая кнопка. Ничего мигающего — админку держат открытой часами."
          >
