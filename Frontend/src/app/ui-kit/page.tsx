    ...
    <main className="min-h-screen bg-gray-bg py-10">
      <div className="shell max-w-4xl">
        ...
        <div className="rounded-2xl border border-gray-border bg-white px-6">
          ...
          <Section
            title="Рубильник"
            note="Для админки: включает и выключает целый кусок сайта. Не галочка — та означает «выбрал из списка», а здесь смысл другой. Включённое положение зелёное: читается как «работает». Красным быть не может — красная кнопка на экране одна и это «Сохранить»."
          >
          ...
          <Section
            ...
            note="Статус заявки. Синяя — не открывали, бледно-синяя — прочитана, янтарная — в работе, зелёная — закрыта, без заливки — убрана из работы. Красной здесь нет намеренно: красный занят целевым действием, и метка рядом с кнопкой читалась бы как вторая кнопка. Ничего мигающего — админку держат открытой часами."
          >
            <div className="flex flex-wrap items-center gap-2">
              <Badge tone="new">Новая</Badge>
              <Badge tone="seen">Просмотрена</Badge>
